...
def getGradients1_seaflow():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  https://raw.githubusercontent.com/armbrustlab/seaflow-sfl/master/curated/SCOPE_16_751.sfl"
    )
    os.system(wget_str)
...
def getGradients1_CTD_summary():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://scope.soest.hawaii.edu/data/gradients/data/kok1606.sum"
    )
    os.system(wget_str)
...
def getGradients1_CTD():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  ftp://ftp.soest.hawaii.edu/dkarl/scope/ctd/gradients1/"
    )
    os.system(wget_str)
...
def getGradients1_LICOR_PAR():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://scope.soest.hawaii.edu/data/gradients/data/gyre_edge_licorpar.txt"
    )
    os.system(wget_str)
...
def getGradients2_seaflow():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  https://raw.githubusercontent.com/armbrustlab/seaflow-sfl/master/curated/MGL1704_751.sfl"
    )
    os.system(wget_str)
...
def getGradients2_navigation():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  https://www.nodc.noaa.gov/archive/arc0130/0183950/1.1/data/0-data/MGL1704_603744_r2rnav/data/MGL1704_bestres.geoCSV"
    )
    os.system(wget_str)
...
def getGradients2_CTD_summary():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://scope.soest.hawaii.edu/data/gradients/data/mgl1704.sum"
    )
    os.system(wget_str)
...
def getGradients2_CTD():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  ftp://ftp.soest.hawaii.edu/dkarl/scope/ctd/gradients2/"
    )
    os.system(wget_str)
...
def getGradients3_seaflow():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  https://raw.githubusercontent.com/armbrustlab/seaflow-sfl/master/curated/KM1906_740.sfl"
    )
    os.system(wget_str)
...
def getGradients3_CTD_summary():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://scope.soest.hawaii.edu/data/gradients/data/gradients3.sum"
    )
    os.system(wget_str)
...
def getGradients3_CTD():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  ftp://ftp.soest.hawaii.edu/dkarl/scope/ctd/gradients3/"
    )
    os.system(wget_str)
...
def getGradients3_LICOR_PAR():
    ...
    wget_str = (
        "wget -P "
        + outputdir
        + " -np -nH --cut-dirs 8 -r  http://scope.soest.hawaii.edu/data/gradients/data/gradients3_licorpar.txt"
    )
    os.system(wget_str)
